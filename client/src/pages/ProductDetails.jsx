...
const ProductDetails = () => {
  ...
  const stockRemaining = (product?.StockNumber || 0) - cartQuantity;
  const inStock = stockRemaining > 0;
    ...
    <div className="mt-12">
      ...
      <div className="flex flex-col md:flex-row gap-16 mt-4">
        ...
        <div className="text-sm w-full md:w-1/2">
          ...
          <p className={`mt-2 text-sm ${inStock ? "text-gray-600" : "text-red-500 font-medium"}`}>
            {inStock
